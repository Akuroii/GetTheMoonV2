    ...
    <div className="relative">
      ...
      >
        ...
        <div className="absolute inset-[18%] overflow-hidden rounded-full">
          {/* Gradient border ring — mask-based, so it frames the photo instead of covering it */}
          <div
            className="absolute inset-0 rounded-full z-10 pointer-events-none"
            style={{
              padding: "1.5px",
              background: "linear-gradient(to bottom, rgba(255,255,255,0.2), rgba(124,111,238,0.3), transparent)",
