    ...
    <div className="relative">
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(124,111,238,0.4), rgba(255,94,168,0.18) 50%, transparent 75%)",
          }}
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.6, 0.8, 0.6],
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(245,196,83,0.15), transparent 60%)",
          }}
          animate={{
            scale: [1.1, 1, 1.1],
            opacity: [0.4, 0.6, 0.4],
        ...
        <div className="absolute inset-[18%] overflow-hidden rounded-full">
          ...
          {/* Gradient border */}
          <div className="absolute inset-0 z-10 rounded-full p-[1.5px] bg-gradient-to-b from-white/20 via-[rgba(124,111,238,0.3)] to-transparent pointer-events-none">
            <div className="h-full w-full rounded-full bg-transparent" />
          </div>

          {/* Glow ring */}
          <div className="absolute inset-0 z-20 rounded-full shadow-[0_0_60px_rgba(124,111,238,0.3),inset_0_1px_0_rgba(255,255,255,0.15)] pointer-events-none" />
        </div>
      ...
      {/* External glow */}
      <div
        className="absolute inset-0 -z-10 blur-[80px] opacity-20 pointer-events-none"
        style={{
          background:
            "radial-gradient(circle at 50% 50%, var(--violet), transparent 60%)",
        }}
      />
    </div>
  );
