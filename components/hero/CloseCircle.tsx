        ...
        return (
          ...
          >
            <motion.div
              ...
              style={{
                animation: reducedMotion ? undefined : `social-moon-drift 9s ease-in-out infinite`,
                animationDelay: `${i * -1.1}s`,
              }}
            >
              {entry.kind === "person" ? (
                <PersonNode name={entry.name} title={entry.title} photoSrc={entry.photoSrc} index={i} />
              ) : (
                <a
                  href={entry.href}
